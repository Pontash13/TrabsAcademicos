...
public class frmJogoPrincipal extends javax.swing.JDialog
{
    ...
    public frmJogoPrincipal(java.awt.Frame parent, boolean modal,Integer NovoJogo_1ou0)
    {
        super(parent, modal);
        if (NovoJogo_1ou0 == 1)this.novojogo = 1;
        initComponents();
    }
    
    
    private Integer novojogo = 0;
    
    
    //int NumeroDoItem == int do Item equivalente, de 1 a 10
    //colocar NumeroDoItem == 0 para esvaziar a àrea de texto
    private void Descricao(Integer NumeroDoItem)
    {
    ...
    private void initComponents() {
        ...
        Itens itens = new Itens(novojogo);
        ...
        pgbItem1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        pgbItem2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        lblQuantidadeItem3.setText(itens.quantidadeItem3.toString());

        pgbItem3.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        lblQuantidadeItem4.setText(itens.quantidadeItem4.toString());

        pgbItem4.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        lblQuantidadeItem5.setText(itens.quantidadeItem5.toString());

        pgbItem5.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        lblQuantidadeItem6.setText(itens.quantidadeItem6.toString());

        pgbItem6.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        lblQuantidadeItem7.setText(itens.quantidadeItem7.toString());

        pgbItem7.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        lblQuantidadeItem8.setText(itens.quantidadeItem8.toString());

        pgbItem8.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        lblQuantidadeItem9.setText(itens.quantidadeItem9.toString());

        pgbItem9.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        lblQuantidadeItem10.setText(itens.quantidadeItem10.toString());

        pgbItem10.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        btnMelhorias.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btnMelhoriasMouseClicked(evt);
            }
        });
    ...
    private void btnMelhoriasMouseClicked(java.awt.event.MouseEvent evt)//GEN-FIRST:event_btnMelhoriasMouseClicked
    {//GEN-HEADEREND:event_btnMelhoriasMouseClicked
        frmMelhorias paodequeijo = new frmMelhorias(null, rootPaneCheckingEnabled);
        paodequeijo.setVisible(true);
    }//GEN-LAST:event_btnMelhoriasMouseClicked
    ...
    public static void main(String args[])
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                frmJogoPrincipal dialog = new frmJogoPrincipal(new javax.swing.JFrame(), true, 1);
